...
#define WS_FIELDBUS_TYPE FIELDBUS_TYPE_PNIO
#if WS_FIELDBUS_TYPE > FIELDBUS_TYPE_PNIO
#error "A wrong IO bus type has been defined!"
#endif

/*
 * The product name is SmartFlow
 * But it will be FlexFlow for the one used in ABB PROFINET type.
 * */
#define USE_FLEXFLOW_FOR_ABB_PN_TYPE
/*
 * Uncomment to enable DCP alive monitor.
 * */
#define ENABLE_PN_DCP_ALIVE_MONITOR
